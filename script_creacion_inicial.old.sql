...
PRINT '[TRACE] INSERT INTO Cliente';
GO

INSERT INTO GDDIENTOS.Cliente(cliente_dni, cliente_nombre, cliente_apellido,
    cliente_fechaNacimiento, cliente_mail, cliente_direccion,
    cliente_telefono, cliente_provincia,cliente_localidad)
...
PRINT '[TRACE] INSERT INTO Cliente END';
PRINT '[TRACE] INSERT INTO Sucursal';
GO

INSERT INTO GDDIENTOS.Sucursal(sucursal_codigo, sucursal_provincia, sucursal_localidad,
...
PRINT '[TRACE] INSERT INTO Sucursal END';
PRINT '[TRACE] INSERT INTO Estado';
GO
...
PRINT '[TRACE] INSERT INTO Estado END';
PRINT '[TRACE] INSERT INTO Pedido';
GO

INSERT INTO GDDIENTOS.Pedido(pedido_numero, pedido_sucursal, pedido_cliente, pedido_fecha, pedido_total, pedido_estado)
SELECT pedido_numero, Sucursal_NroSucursal, cliente_codigo, pedido_fecha, pedido_total, estado_numero 
	...
	GROUP BY pedido_numero, Sucursal_NroSucursal, cliente_codigo, pedido_fecha, pedido_total, estado_numero
;
GO

PRINT '[TRACE] INSERT INTO Pedido END';
PRINT '[TRACE] INSERT INTO Pedido_Cancelacion';
GO

INSERT INTO GDDIENTOS.Pedido_Cancelacion(pedido_cancelacion_pedido, pedido_cancelacion_fecha, pedido_cancelacion_motivo)
...
PRINT '[TRACE] INSERT INTO Pedido_Cancelacion END';
PRINT '[TRACE] INSERT INTO Factura';
GO
...
PRINT '[TRACE] INSERT INTO Factura END';
PRINT '[TRACE] INSERT INTO Envio';
GO
...
PRINT '[TRACE] INSERT INTO Envio END';
PRINT '[TRACE] INSERT INTO Medida';
GO

INSERT INTO GDDIENTOS.Medida(medida_ancho, medida_alto, medida_profundidad, medida_precio)
SELECT Sillon_Medida_Ancho, Sillon_Medida_Alto, Sillon_Medida_Profundidad, Sillon_Medida_Precio FROM gd_esquema.Maestra 
WHERE Sillon_Medida_Alto IS NOT NULL
GROUP BY Sillon_Medida_Ancho, Sillon_Medida_Alto, Sillon_Medida_Profundidad, Sillon_Medida_Precio
;
GO

PRINT '[TRACE] INSERT INTO Medida END';
PRINT '[TRACE] INSERT INTO Sillon_Modelo';
GO

INSERT INTO GDDIENTOS.Sillon_Modelo(sillon_modelo_codigo, sillon_modelo, sillon_modelo_descripcion, sillon_modelo_precio)
SELECT Sillon_Modelo_Codigo, Sillon_Modelo, Sillon_Modelo_Descripcion, Sillon_Modelo_Precio
FROM gd_esquema.Maestra
GROUP BY Sillon_Modelo_Codigo, Sillon_Modelo, Sillon_Modelo_Descripcion, Sillon_Modelo_Precio
HAVING Sillon_Modelo_Codigo IS NOT NULL
;
GO

PRINT '[TRACE] INSERT INTO Sillon_Modelo END';
PRINT '[TRACE] INSERT INTO Sillon';
GO

INSERT INTO GDDIENTOS.Sillon(sillon_codigo, sillon_modelo, sillon_modelo_precio, sillon_medida, sillon_medida_precio)
SELECT sillon_codigo, Ms.Sillon_Modelo_Codigo, Ms.sillon_modelo_precio, medida_codigo, sillon_medida_precio
FROM gd_esquema.Maestra Ms
...
GROUP BY sillon_codigo, Ms.Sillon_Modelo_Codigo, Ms.sillon_modelo_precio, medida_codigo, sillon_medida_precio
;
GO

PRINT '[TRACE] INSERT INTO Sillon END';
PRINT '[TRACE] INSERT INTO Item_Pedido';
GO
...
PRINT '[TRACE] INSERT INTO Item_Pedido END';
PRINT '[TRACE] INSERT INTO Item_Factura';
GO
...
PRINT '[TRACE] INSERT INTO Item_Factura END';
PRINT '[TRACE] INSERT INTO Proveedor';
GO
...
PRINT '[TRACE] INSERT INTO Proveedor END';
PRINT '[TRACE] INSERT INTO Compra END';
GO
...
PRINT '[TRACE] INSERT INTO Compra END';
PRINT '[TRACE] INSERT INTO Tipo_Material';
GO
...
PRINT '[TRACE] INSERT INTO Tipo_Material END';
PRINT '[TRACE] INSERT INTO Material';
GO
...
PRINT '[TRACE] INSERT INTO Material END';
PRINT '[TRACE] INSERT INTO Item_Compra';
GO
...
PRINT '[TRACE] INSERT INTO Item_Compra END';
PRINT '[TRACE] INSERT INTO Sillon_Material';
GO
...
PRINT '[TRACE] INSERT INTO Tela END';
PRINT '[TRACE] INSERT INTO Madera';
GO
...
PRINT '[TRACE] INSERT INTO Madera END';
PRINT '[TRACE] INSERT INTO Relleno';
GO
...
PRINT '[TRACE] INSERT INTO Relleno END';
