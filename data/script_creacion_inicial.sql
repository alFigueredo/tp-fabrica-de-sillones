...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Provincia
        (provincia_nombre)
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Localidad
        (localidad_nombre, localidad_provincia)
    SELECT sucursal_localidad, provincia_codigo
    FROM gd_esquema.Maestra
    ...
    INSERT INTO GDDIENTOS.Localidad
        (localidad_nombre, localidad_provincia)
    SELECT cliente_localidad, provincia_codigo
    FROM gd_esquema.Maestra
    ...
    INSERT INTO GDDIENTOS.Localidad
        (localidad_nombre, localidad_provincia)
    SELECT proveedor_localidad, provincia_codigo
    FROM gd_esquema.Maestra
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Sucursal
        (sucursal_codigo, sucursal_provincia,
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Pedido
        (pedido_numero, pedido_sucursal,
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Pedido_Cancelacion
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Factura
        (factura_numero, factura_cliente,
...
BEGIN
    SET NOCOUNT ON
    INSERT INTO GDDIENTOS.Envio
        (envio_numero, envio_factura_numero,
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Sillon_Modelo
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Sillon
        (sillon_codigo, sillon_modelo,
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Item_Pedido
        (item_pedido_codigo_pedido, item_pedido_sillon,
...
BEGIN
    SET NOCOUNT ON
    INSERT INTO GDDIENTOS.Proveedor
        (proveedor_cuit, proveedor_razonSocial,
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Compra
        (compra_numero, compra_sucursal,
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Tipo_Material
        (tipo_material_nombre)
    SELECT material_tipo
    FROM gd_esquema.Maestra
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Material
        (material_tipo, material_nombre,
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Item_Compra
        (item_compra_codigo_compra, item_compra_material,
...
BEGIN
    SET NOCOUNT ON
    INSERT INTO GDDIENTOS.Sillon_Material
        (sillon_material_codigo_sillon,
...
BEGIN
    SET NOCOUNT ON
    INSERT INTO GDDIENTOS.Tela
        (tela_material_codigo, tela_color, tela_textura)
...
BEGIN
    ...
    INSERT INTO GDDIENTOS.Madera
        (madera_material_codigo, madera_color, madera_dureza)
...
BEGIN
    SET NOCOUNT ON
    INSERT INTO GDDIENTOS.Relleno
        (relleno_material_codigo, relleno_densidad)
